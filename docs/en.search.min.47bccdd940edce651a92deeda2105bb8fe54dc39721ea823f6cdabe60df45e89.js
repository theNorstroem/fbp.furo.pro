...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.08c9a03d1bd19285a895f29f371630fa7efc578896cd724d6d62de95c5cfac79.js',function(){input.required=false;search();});}
